...
This feature helps direct/split traffic between services within a mesh(using Locality Fail-over or Locality-weighted load balancing) 
to enable high availability and fast response time for workloads.
