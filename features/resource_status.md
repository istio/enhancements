...
**Feature name:** Istio Resource Status

[//]: # (The name of the feature, e.g. Multiple control planes)

**Primary lead(s):** Mitch Conners, Ed Snible, Tong Li
...
Allow users to use enableAnalysis flag to enable Istio analyzier to reflect status of a resource in kubernetes resource status field so that users can view the Istio resource status with `kubectl` command 

**Design Docs:**

[//]: # (Design docs for feature)

https://docs.google.com/document/d/1OipeJ1NnBAGkw27CSL02eykbhF8zRdWKBfwtrqQOhNE/edit#
...
- [x] Stability/stress test suite includes coverage for the feature.
    ...
    https://github.com/istio/istio/issues/30179
...
- [x] Feature has no known major issues.
    Resolved issues: https://github.com/istio/istio/issues/30179

**Approvals**

- [x] The appropriate work group(s) have reviewed and approved promotion of the feature.
- [x] The supportability review panel has reviewed promotion of the feature OR a WG has decided one is not required.  
