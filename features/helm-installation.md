...
Jacob Delgado (jacob-delgado)

[//]: # (The primary lead or leads responsible for the feature. These individuals serve as a point of contact for the feature.)

**Short description:**

Provides users with the ability to install and upgrade Istio using Helm.
...
- [X] RFC has been approved describing the intention of the feature as well as the user stories behind the feature. 
  [Support for Helm3](https://docs.google.com/document/d/1upInT_Qe3-CU2ig_XnUNjP2wLyBr6ImpJfMXvz-BYec/edit#heading=h.zdt8tdr2tq7n)
  [Helm Migration to IstioOperator](https://docs.google.com/document/d/1P7GAWKH8kiI9SC83TIjyEfBmUbBaRreDwciQiDNu_Sc/edit#heading=h.97r5w4kzb9xz)
  [Helm and IstioOperator API convergence](https://docs.google.com/document/d/145nnp23z-y9qyMw0pSM0w0SzVghhRCFqMj8P8ANH3mg/edit#heading=h.xw1gqgyqs5b)
...
- [X] Automated integration tests cover core use cases with the feature enabled. 
  [Helm integration tests](https://github.com/istio/istio/tree/master/tests/integration/helm) 
