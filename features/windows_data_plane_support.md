...
**Feature name:** Support Windows in data plane (sidecar injection and traffic capture)

[//]: # (The name of the feature, e.g. Multiple control planes)

**Primary lead(s):** @sunjayBhatia

[//]: # (The primary lead or leads responsible for the feature. These individuals serve as a point of contact for the feature.)

**Short description:** This feature intends to support Windows applications deployed in Kubernetes in an Istio service mesh. Windows developers/operators should have (pragmatic) parity in features they can use to observe, manage, etc. their service mesh including Windows applications.
