...
Control the sampling rate for the mesh in Istio using trace sampling.
...
[Configurability](https://istio.io/latest/docs/tasks/observability/distributed-tracing/configurability/#trace-sampling)
