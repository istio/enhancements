...
A fully configured deployment of Prometheus in Istio for demo purpose.
...
[Prometheus Scraping Standardization](https://docs.google.com/document/d/1TTeN4MFmh4aUYYciR4oDBTtJsxl5-T5Tu3m3mGEdSo8/edit#)
...
N/A This feature has been around since 0.1 and approved for stable by WG
...
[Prometheus Performance and Scalability](https://istio.io/latest/docs/ops/deployment/performance-and-scalability/)
...
- [x] The [supportability review panel](https://docs.google.com/document/d/1w0epyFhhDSf_TwFEfa_lrn1v61mXNJKpEp_kUgp4sSc/edit#) has reviewed the feature in order to find any supportability concerns.  
  > N/A This feature has been around since 0.1, with no known issues  and approved for stable by WG
- [x] The TOC has reviewed and approved promotion of the feature as part of the
	roadmap for a release.
  > N/A This feature has been around since 0.1, with no known issues and approved for stable by WG
