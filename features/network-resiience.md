...
Network resilience features: timeouts, retries, connection pools, outlier detection
...
Opt-in failure recovery and fault injection features that can be configured dynamically at runtime to improve network resilience.
