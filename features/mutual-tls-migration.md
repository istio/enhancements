...
**Primary lead(s):**
Jianfei Hu, Limin Wang

[//]: # (The primary lead or leads responsible for the feature. These individuals serve as a point of contact for the feature.)

**Short description:**
Ensure workloads communicate with each other using only mutual TLS as they are migrated to Istio.
[//]: # (A short description of the feature. One or two sentences maximum.)


**Design Docs:**
[Istio mTLS adoption simplification](https://docs.google.com/document/d/1hlgLGTFZ-7jsRMEDCECHzvWEChMQp9xKdTorpNg6gKk/edit#heading=h.izp4cu5btvyg)
